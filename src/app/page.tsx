        ...
        <section className="pt-24 pb-20 px-4">
          <div className="container mx-auto text-center max-w-5xl">
            ...
            <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed">
              Connect your wallet, play Chess, Tetris, Snake, Memory & 2048! 
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-5">
              {[
                { icon: Crown, name: "Chess", desc: "Beat the AI", color: "from-amber-500 to-orange-600", reward: "50 GAT" },
                { icon: Gamepad2, name: "Tetris", desc: "Stack & clear", color: "from-purple-500 to-pink-600", reward: "1 GAT/100pt" },
                { icon: Zap, name: "Snake", desc: "Eat & grow", color: "from-green-500 to-emerald-600", reward: "1 GAT/10pt" },
                { icon: Star, name: "Memory", desc: "Match pairs", color: "from-orange-500 to-red-600", reward: "Efficiency bonus" },
                { icon: Grid3X3, name: "2048", desc: "Merge tiles", color: "from-cyan-500 to-blue-600", reward: "1 GAT/100pt" },
              ].map((game, i) => (
                <div
                  key={game.name}
