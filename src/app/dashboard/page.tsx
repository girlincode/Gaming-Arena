...
export default function DashboardPage() {
  ...
  const games = [
    { id: "chess", name: "Chess", icon: Crown, color: "from-amber-500 to-orange-600", borderColor: "border-amber-500/20", score: user.scores.chess, href: "/games/chess", reward: "50 GAT" },
    { id: "tetris", name: "Tetris", icon: Gamepad2, color: "from-purple-500 to-pink-600", borderColor: "border-purple-500/20", score: user.scores.tetris, href: "/games/tetris", reward: "1 GAT/100pt" },
    { id: "snake", name: "Snake", icon: Zap, color: "from-green-500 to-emerald-600", borderColor: "border-green-500/20", score: user.scores.snake, href: "/games/snake", reward: "1 GAT/10pt" },
    { id: "memory", name: "Memory", icon: Star, color: "from-orange-500 to-red-600", borderColor: "border-orange-500/20", score: user.scores.memory, href: "/games/memory", reward: "Efficiency" },
    { id: "2048", name: "2048", icon: Grid3X3, color: "from-cyan-500 to-blue-600", borderColor: "border-cyan-500/20", score: user.scores.game2048, href: "/games/2048", reward: "1 GAT/100pt" },
  ];
